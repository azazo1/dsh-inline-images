...
var InlineImagesRuntime = class extends TypertRemoteService {
  ...
  async resolveImage(args) {
    ...
    if (!ABSOLUTE_PATH_RE.test(raw) && (args.cwd === void 0 || args.cwd.trim() === "")) return {};
    try {
      const target = await fs.resolve(raw, args.cwd === void 0 ? void 0 : { cwd: args.cwd });
      const info = await fs.stat(target);
      if (info === void 0 || info.type !== "file") return {};
      const token = this.credentials === void 0 ? void 0 : await this.ensureToken(
