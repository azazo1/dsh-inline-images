...
// src/config.ts
var Config = z.object({
  maxWidth: z.number().min(SIZE_MIN).max(SIZE_MAX).default(DEFAULT_MAX_WIDTH).description("\u5BF9\u8BDD\u6B63\u6587\u5185\u8054\u56FE\u7247\u7684\u6700\u5927\u5BBD\u5EA6, \u5355\u4F4D\u50CF\u7D20.").volatile(),
  maxHeight: z.number().min(SIZE_MIN).max(SIZE_MAX).default(DEFAULT_MAX_HEIGHT).description("\u5BF9\u8BDD\u6B63\u6587\u5185\u8054\u56FE\u7247\u7684\u6700\u5927\u9AD8\u5EA6, \u5355\u4F4D\u50CF\u7D20.").volatile()
});
