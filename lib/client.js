  ...
  window.__ModuleLoader__.load({
    ...
    factory: (req) => {
      ...
      function InlineSettings(props) {
        ...
        return el(
          "div",
          { style: { display: "flex", flexDirection: "column", gap: 10, maxWidth: DEFAULT_MAX_WIDTH } },
          el(
            "div",
          ...
          el(
            ...
            el("input", { type: "number", min: SIZE_MIN, max: SIZE_MAX, value: maxWidth, title: "\u5BBD\u5EA6 px", onChange: (e) => setMaxWidth(e.target.value), style: inputStyle }),
            el("span", null, "x"),
            el("input", { type: "number", min: SIZE_MIN, max: SIZE_MAX, value: maxHeight, title: "\u9AD8\u5EA6 px", onChange: (e) => setMaxHeight(e.target.value), style: inputStyle }),
